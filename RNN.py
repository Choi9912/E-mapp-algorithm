...
import sys
from model.service import rnnService as model_service
...
class RNN:
    ...
    def __init__(self, argv):
        ...
        self.log.print('{0}-{1} Rnn 속성 설정 완료'.format(self.workflow_no, self.workflow_item_no))
    ...
    def execute(self):
        ...
        opt = params['opt']
        epochs_ = params['epochs_']
        service = model_service.rnnService(exec_mode, vocab_size, original, translation, hidden_size, opt, epochs_)
