...
from model.service import logisticRegressionService as model_service
...
class logisticRegression:
    ...
    def execute(self):
        ...
        service = model_service.logisticRegressionService(evaluation_mode, penalty, dual, tol, C, fit_intercept,
                                                          intercept_scaling, class_weight, random_state, solver,
                                                          max_iter, multi_class, verbose, warm_start, n_jobs,
                                                          l1_ratio, n_splits, self.log)
...
def main():
    ...
    workflow_model = logisticRegression(sys.argv)
    # 모델을 실행시킨다.
